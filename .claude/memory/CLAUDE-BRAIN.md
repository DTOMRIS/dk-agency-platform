...
- **Sənəd:** `scripts/verify-lessons.mjs` — kodda istinad edilən hər `L-0XX` LESSONS.md-də olmalıdır (dk-validate 5b). Task kartı `docs/tasks/TASK-XXXX.md` məcburidir. Növbəti task ID: **0449**.
