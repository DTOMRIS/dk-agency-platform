      ...
      <div className="mx-auto max-w-6xl px-4 py-16">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-lg text-slate-600">
            İndi paywall işləyir, auth adapter local və ya Supabase modunda çalışa bilir. Ödəniş provideri gələndə bu qat birbaşa subscription sisteminə çevriləcək.
          </p>
        </div>
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-3">
          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <p className="mt-3 text-sm text-slate-600">
              Cari rejim: <span className="font-semibold">{capability.provider}</span>. Supabase env gələndə provider avtomatik `supabase` olur.
            </p>
          </div>
        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <aside className="rounded-3xl border border-slate-200 bg-slate-950 p-8 text-white shadow-sm">
            ...
            <ul className="mt-6 space-y-4 text-sm text-slate-300">
              <li>1. Supabase auth provider və email verification</li>
              <li>2. Payment webhook ilə entitlement açılması</li>
