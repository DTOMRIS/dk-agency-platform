...
export async function POST(request: NextRequest) {
  ...
  const inserted = await db
    ...
    .values({
      ...
      status: isAdmin && body.initialStatus ? body.initialStatus : 'submitted',
      isShowcase: isAdmin ? Boolean(body.isShowcase) : false,
      isFeatured: isAdmin ? Boolean(body.isFeatured) : false,
