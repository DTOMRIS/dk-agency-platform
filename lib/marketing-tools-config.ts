      ...
      fields: [
        {
          ...
          required: true,
          options: [
            { value: 'morning', labelKey: 'peakHours.morning' },
            { value: 'lunch', labelKey: 'peakHours.lunch' },
            { value: 'dinner', labelKey: 'peakHours.dinner' },
            { value: 'lateNight', labelKey: 'peakHours.lateNight' },
            { value: 'all', labelKey: 'peakHours.all' },
          ],
        },
        {
          name: 'customerPurpose',
          type: 'select',
          required: true,
          options: [
            { value: 'eat', labelKey: 'purpose.eat' },
            { value: 'work', labelKey: 'purpose.work' },
            { value: 'celebrate', labelKey: 'purpose.celebrate' },
            { value: 'relax', labelKey: 'purpose.relax' },
            { value: 'thirdPlace', labelKey: 'purpose.thirdPlace' },
          ],
        },
        {
          name: 'foodStory',
