...
export const MOCK_LISTINGS: MockListing[] = [
  {
    ...
    typeSpecificData: {
      ...
      rentAmount: 4200,
      staffCount: 11,
      reason: 'Fokus başqa layihəyə keçir.',
  ...
  },
  {
    ...
    phone: '994501112244',
    email: 'franchise@dkagency.com.tr',
    images: [
    ...
    typeSpecificData: {
      ...
      supportPackage: 'Açılış təlimi, marketinq, resept kitabı',
      trainingIncluded: true,
      exclusiveTerritory: 'Yasamal',
      currentLocations: 3,
      contractYears: 5,
    },
    reviewNotes: [
      note('Brend sənədləri tamdır, vitrin üçün uyğundur.', 5, '2026-03-23T16:00:00.000Z'),
    ],
  ...
  },
  {
    ...
    typeSpecificData: {
      brand: 'HORECA Mix',
      model: 'Pro Set 2024',
      condition: 'İstifadə olunmuş - əla',
      warranty: 3,
      quantity: 8,
      dimensions: 'Paket satış',
  ...
  },
  {
    ...
    typeSpecificData: {
      ...
      floor: '1',
      ceilingHeight: 4.2,
      hasKitchenInfra: true,
      hasVentilation: true,
      parkingSpaces: 6,
      previousUse: 'Restoran',
      availableFrom: 'Dərhal',
    },
  ...
  },
  {
    ...
    isFeatured: false,
    typeSpecificData: {
      businessType: 'Üçüncü nəsil qəhvə',
      investmentNeeded: 30000,
      partnerRole: 'Sərmayə və growth partnyoru',
      currentStage: 'Konsept hazır',
      revenueShare: '25% pay',
    },
    reviewNotes: [
      note('Pitch güclüdür, investor marağı yüksəkdir.', 5, '2026-03-25T09:15:00.000Z'),
    ],
  ...
  },
  {
    ...
    phone: '994501112288',
    email: 'franchisealmaq@dkagency.com.tr',
    images: [
    ...
    isFeatured: false,
    typeSpecificData: {
      desiredCategory: 'Fast food',
      budget: 100000,
      preferredCity: 'Bakı',
      experience: '6 illik əməliyyat idarəçiliyi',
      timeline: '3 ay içində başlamaq istəyir',
    },
  ...
  },
  {
    ...
    phone: '994507770001',
    email: 'operator7@dkagency.com.tr',
    images: [{ id: '7-1', url: IMG[2], alt: 'Franchise almaq cover' }],
    isShowcase: false,
    isFeatured: false,
    typeSpecificData: {
      desiredCategory: 'Burger',
      budget: 65000,
      preferredCity: 'Bakı',
      experience: '2 il kafe idarəçiliyi',
      timeline: 'Yay mövsümündə',
    },
  ...
  },
  {
    ...
    description:
      'Əməliyyat göstəriciləri güclüdür, amma komitə maliyyə sənədlərini dərinləşdirilmiş şəkildə yoxlayır.',
    price: 72000,
    currency: 'AZN',
    city: 'Bakı',
    district: 'Nizami',
  ...
  },
  {
    ...
    description:
      'Avadanlıq siyahısı göndərilib, lakin alış sənədi və servis tarixçəsi əlavə tələb olunub.',
    price: 18500,
    currency: 'AZN',
    city: 'Gəncə',
    district: 'Mərkəz',
    ...
    phone: '994507770003',
    email: 'ekipman9@dkagency.com.tr',
    ...
    typeSpecificData: {
      brand: 'CoolTech',
      model: 'Line 900',
      condition: 'İstifadə olunmuş - yaxşı',
      warranty: 0,
      quantity: 5,
      dimensions: 'Müxtəlif',
      powerRequirement: '220V / 380V',
    },
  ...
  },
  {
    ...
    phone: '994507770004',
    email: 'obyekt10@dkagency.com.tr',
    ...
    reviewNotes: [
      note('Ventilyasiya və tavan hündürlüyü səbəbilə rədd edildi.', 2, '2026-03-29T14:00:00.000Z'),
    ],
    leads: [],
  ...
  },
  {
    ...
    description:
      'Cloud kitchen modelində böyümək istəyən layihə ilkin mərhələdə ortaqlıq sorğusu yaradıb.',
    price: 40000,
    currency: 'AZN',
    city: 'Bakı',
    district: 'Xətai',
    ...
    typeSpecificData: {
      ...
      partnerRole: 'Operativ partnyor',
      currentStage: 'MVP hazırlanır',
      revenueShare: '30% pay',
    },
  ...
  },
  {
    ...
    description:
      'Yeni investisiya layihəsi olaraq komitəyə çıxarılıb. Biznes plan və ROI göstəriciləri baxılır.',
    price: 150000,
    currency: 'AZN',
    city: 'Bakı',
    district: 'Səbail',
    ...
    phone: '994507770006',
    email: 'invest12@dkagency.com.tr',
    images: [{ id: '12-1', url: IMG[1], alt: 'Yeni investisiya cover' }],
    isShowcase: false,
    isFeatured: false,
    typeSpecificData: {
      concept: 'Premium seafood restoran',
      totalBudget: 240000,
    ...
    reviewNotes: [
      note('Komitə ROI hesablamasını yenidən yoxlayır.', 4, '2026-03-29T17:20:00.000Z'),
    ],
    leads: [],
