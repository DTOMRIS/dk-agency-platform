...
export default function MobileBottomNav() {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 border-t border-[color:color-mix(in_srgb,var(--dk-muted)_13%,transparent)] bg-[var(--dk-night)]/95 backdrop-blur-md">
            ...
            <li key={item.href}>
              <Link
                ...
                className={`flex flex-col items-center justify-center gap-1 py-2.5 text-[11px] ${
                  active ? 'text-[var(--dk-gold)]' : 'text-[var(--dk-body)]'
                }`}
              >
                <Icon size={16} />
