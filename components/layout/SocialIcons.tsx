// components/layout/SocialIcons.tsx
// DK Agency — Unified Social Media Icons (Dark Theme)
// E94560 background, hover:C5A022, white icons
...
const socialLinks: SocialLink[] = [
  {
    name: 'Instagram',
    href: 'https://instagram.com/dkagency',
    icon: (
  ...
  {
    name: 'LinkedIn',
    href: 'https://linkedin.com/company/dkagency',
    icon: (
      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'Facebook',
    href: 'https://facebook.com/dkagency',
    icon: (
      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'Twitter',
    href: 'https://twitter.com/dkagency',
    icon: (
      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'YouTube',
    href: 'https://youtube.com/@dkagency',
    icon: (
      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
...
// Individual Social Icon for custom usage
