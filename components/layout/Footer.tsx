...
export function KazanAIBot() {
  return (
    ...
    >
      <Link
        href="/kazan-ai"
        aria-label="KAZAN AI-ya sual ver"
        className="flex h-16 w-16 items-center justify-center rounded-2xl bg-[#1A1A2E] text-[#C5A022] shadow-2xl shadow-[#1A1A2E]/30"
      >
        <span className="pointer-events-none absolute -top-12 right-0 rounded-xl bg-white px-4 py-2 text-xs font-bold whitespace-nowrap text-slate-900 opacity-0 shadow-xl transition-all group-hover:opacity-100">
