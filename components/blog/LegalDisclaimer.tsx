    ...
    <div className="mt-12 rounded-xl border border-slate-200 bg-slate-50 p-5">
      <div className="flex items-start gap-3">
        ...
        <p className="text-sm leading-relaxed text-slate-600">
          <strong className="text-slate-700">Hüquqi qeyd:</strong> Bu yazı ümumi
          məlumat xarakteri daşıyır və hüquqi məsləhət deyil. Konkret addımlar
          üçün patent vəkili və ya hüquqşünasa müraciət edin.
        </p>
      </div>
    </div>
  );
