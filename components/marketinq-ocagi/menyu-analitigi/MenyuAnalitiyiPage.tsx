    ...
    <div className="mx-auto max-w-3xl px-6 py-8">
      ...
      {view !== 'result' && (
        <ToolInfoBox title="Niyə bu vacibdir?" variant="info">
          <p>Menyunun 20%-i satışın 80%-ni yaradır (Pareto qaydası). Bu alət Boston BCG matrisi ilə hər yeməyi 4 kateqoriyaya bölür: STAR - yüksək satış + yüksək marja, PLOWHORSE - yüksək satış + aşağı marja, PUZZLE - aşağı satış + yüksək marja, DOG - aşağı satış + aşağı marja.</p>
        </ToolInfoBox>
      )}
