          ...
          <div key={idx} className="rounded-xl border border-slate-200 bg-white p-3">
            <div className="grid grid-cols-1 gap-3 md:grid-cols-5">
              <input type="text" placeholder={t.itemName} value={item.name}
                ...
                className="min-w-0 w-full rounded-lg border border-slate-200 px-3 py-2 text-sm focus:border-[var(--dk-gold)] focus:outline-none" />
              ...
              <div className="flex min-w-0 gap-2">
                <input type="number" placeholder={t.monthlySales} value={item.monthlySales ?? ''} min={0}
                  ...
                  title={t.salesHelp}
                  className="min-w-0 flex-1 rounded-lg border border-slate-200 px-3 py-2 text-sm focus:border-[var(--dk-gold)] focus:outline-none" />
                {items.length > 5 && (
