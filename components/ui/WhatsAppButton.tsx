...
export default function WhatsAppButton() {
  return (
    <div className="fixed z-50 bottom-20 right-4 md:bottom-8 md:right-8 group">
      <span className="pointer-events-none absolute right-16 top-1/2 -translate-y-1/2 whitespace-nowrap rounded-lg bg-[var(--dk-ink)] px-3 py-1.5 text-xs font-semibold text-white opacity-0 shadow-lg transition-opacity duration-200 group-hover:opacity-100">
        Bize yazin
      </span>
      ...
      <Link
        ...
        className="relative flex h-14 w-14 items-center justify-center rounded-full bg-[var(--dk-social-whatsapp)] text-white shadow-[0_10px_30px_rgba(37,211,102,0.45)] transition-transform duration-200 hover:scale-105"
      >
        <span className="absolute inset-0 rounded-full bg-[var(--dk-social-whatsapp)] animate-ping opacity-40" />
