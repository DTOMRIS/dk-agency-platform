...
- `TASK-0234` feat(home): applied the AI Studio light navbar and hero fullspec with the 42px DK logo block, five centered desktop links, green/red CTAs, fully localized hero copy, responsive gradient photo fallback, and emerald `+34%` stat card. Header auth/session logic remains intact.
